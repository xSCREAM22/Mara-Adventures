...
EventHandlers.add(:following_pkmn_talk, :music_generic, proc { |pkmn, random_val|
  if random_val == 0
    ...
    messages = [
      ...
      _INTL("¡{1} se ha puesto ha bailar de alegría!"),
...
EventHandlers.add(:following_pkmn_talk, :ellipses_generic, proc { |pkmn, random_val|
  if random_val == 2
    ...
    messages = [
      ...
      _INTL("{1} está profundamente concentrado."),
...
EventHandlers.add(:following_pkmn_talk, :heart_generic, proc { |pkmn, random_val|
  if random_val == 4
    ...
    pbMoveRoute($game_player, [PBMoveRoute::WAIT, 20])
    messages = [
      _INTL("{1} de repente comenzó a caminar más cerca de {2}."),
      ...
      _INTL("{1} se da vuelta y mira a {2} expectante."),
...
EventHandlers.add(:following_pkmn_talk, :generic,  proc { |pkmn, random_val|
  if random_val == 5
    messages = [
      ...
      _INTL("{1} dejó escapar un grito de batalla."),
      _INTL("¡{1} está alerta!"),
      _INTL("{1} está de pie pacientemente."),
      _INTL("{1} mira inquieto a su alrededor."),
      ...
      _INTL("{1} permanece en su lugar, esperando a que {2} haga un movimiento."),
